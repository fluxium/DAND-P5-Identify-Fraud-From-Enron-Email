...
test_score = reg.score(reg.predict(ages_test), net_worths_test) ### fill in the line of code to get the right value


### get the score on the training data
training_score = reg.score(reg.predict(ages_train), net_worths_train) ### fill in the line of code to get the right value
